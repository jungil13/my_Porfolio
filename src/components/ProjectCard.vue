  <template>
  <article
    class="group relative rounded-2xl bg-white border border-slate-200 overflow-hidden hover:border-primary-500/50 shadow-sm hover:shadow-lg hover:shadow-primary-500/10 transition-all duration-300 flex flex-col"
  >
    <!-- Project image -->
    <div class="relative h-40 sm:h-44 bg-slate-100 overflow-hidden">
      ...
      >
        <div class="p-4 rounded-2xl bg-primary-100 text-primary-500">
    ...
    <div class="p-6 flex flex-col flex-1">
      <div class="flex items-start justify-between gap-3 mb-3">
        ...
        <div class="flex items-center gap-3 shrink-0">
          <a
            ...
            class="flex items-center gap-1.5 text-sm text-slate-600 hover:text-primary-600 transition-colors"
            title="Open GitHub"
          >
      ...
      <div class="flex flex-wrap gap-2">
        <span
          ...
          :key="tag"
          class="px-2.5 py-1 text-xs font-medium rounded-lg bg-slate-100 border border-slate-200 text-slate-600"
        >
          {{ tag }}
        </span>
      </div>
